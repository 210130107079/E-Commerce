...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
        <Link to='/'><img src={assets.logo} className='w-40 h-17' alt="" /></Link>
        ...
        <div className='flex items-center gap-6'>
            ...
            <Link to='/cart' className='relative'>
                ...
                <p className='absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-slate-600 text-white aspect-square rounded-full text-[8px]'>{getCartCount()}</p>
            </Link>
